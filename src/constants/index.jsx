...
export const PROFILE = {
  ...
  subheading:
    "With 1 year of full-stack development experience, I build efficient, scalable web applications. Not on the job hunt, but always curious about interesting projects.",
};
...
export const SKILLS = [
  ...
  {
    name: "Nextjs",
    icon: <TbBrandNextjs className="text-black-400" />,
  },
  {
    name: "DevOps",
    icon: <VscAzureDevops className="text-blue-400" />,
  },
  {
    name: "PostGre",
...
export const EXPERIENCES = [
  ...
  },
  {
    ...
    techStack: ["JS", "Nodejs", "MongoDB", "React"],
  },
];
...
export const EDUCATION = [
  {
    ...
    duration: "2023 - 2027",
    description:
      "Graduating with honors in Computer Science, focusing on algorithms, data structures, and web development. Completed a capstone project on scalable cloud architectures.",
  },
  {
    id: 2,
    degree: "Master of Science in Software Engineering",
    institution: "Not yet decided",
    duration: "2016 - 2018",
    description:
  ...
  },
  {
    ...
    duration: "2025 - 2026",
    description:
      "Earned a certification in advanced software development, and performance optimization.",
  },
];
...
export const TESTIMONIAL = {
  ...
  title: "CEO, TechCorp",
  quote:
    "Working with Fareed was a game-changer. His expertise in full-stack development helped us scale our product with ease. His attention to detail and passion for quality are unmatched.",
  image: personImage,
};
